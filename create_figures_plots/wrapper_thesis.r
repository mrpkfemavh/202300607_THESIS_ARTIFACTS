...
human_samples$Median_blind <- human_samples$Median_blind %>% as.integer() %>% as.character()
human_samples$Median_aware <- human_samples$Median_aware %>% as.integer() %>% as.character()
...
# table: synthetic_samples_to_xtable --------------------------------------
