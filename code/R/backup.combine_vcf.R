...
# THESIS_POS	THESIS_BASE_CHANGE	THESIS_VARIANT	THESIS_VARIANT_BY_POS	THESIS_VARIANT_BY_HGVS
# 1	A>T	A>T:1	1:A>T	MN908947_3.1A>T
# 1	A>G	A>G:1	1:A>G	MN908947_3.1A>G
# 1	A>C	A>C:1	1:A>C	MN908947_3.1A>C
# 1	A>T	A>T:1	1:A>T	MN908947_3.1A>T

# dir_data_generated <- "/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_generated"
...
# collection_date <- read_csv(file_all_collection, col_types = cols(DATE_BEST_COLLECTION_SUBMISSION = col_character())) %>% tibble()
# 
# fingerprint_variant_nucmer_MT007544 <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/MN908947.3_MT007544.1.tsv")
# #fingerprint_variant_nucmer_MN908947 <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/MN908947.3_MN908947.3.tsv")
# fingerprint_variant_nucmer_EPI_ISL_6841980 <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/MN908947.3_EPI_ISL_6841980.tsv")
# fingerprint_variant_nucmer_EPI_ISL_2693246 <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/MN908947.3_EPI_ISL_2693246.tsv")
# fingerprint_variant_nucmer_EPI_ISL_710528 <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/MN908947.3_EPI_ISL_710528.tsv")

# nucmer_file_list <- c("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/MN908947.3_MT007544.1.tsv", "/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/MN908947.3_EPI_ISL_6841980.tsv", "/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/MN908947.3_EPI_ISL_2693246.tsv", "/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/MN908947.3_EPI_ISL_710528.tsv")
# 
# fingerprint_variant_nucmer_all <- vroom(nucmer_file_list, col_names = FALSE)
# 
# 
# view(fingerprint_variant_nucmer_MT007544)

# fingerprint_variant_alpha <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_EPI_ISL_710528_alpha.csv")
# fingerprint_variant_delta <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_EPI_ISL_2693246_delta.csv")
# fingerprint_variant_omicron <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_EPI_ISL_omicron.csv")
# fingerprint_variant_SNPS <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_fingerprint_all.csv")
# fingerprint_variant_australia <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_MT007544_1_australia.csv")
# fingerprint_variant_all <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/MN908947_3_all_snp.csv")
# fingerprint_variant_SNPS_goldmaster <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_fingerprint_all.csv")

# colnames(fingerprint_variant_all)
# view(fingerprint_variant_all %>% filter(QUERY != ".")) 
# 
# colnames(fingerprint_variant_SNPS_goldmaster)
# view(fingerprint_variant_SNPS_goldmaster)
# view(fingerprint_variant_SNPS_goldmaster %>% filter(QUERY != "."))
# 
# fingerprint_variant_all$QUERY_TAG %>% unique()
# fingerprint_variant_all$REFERENCE_POSITION %>% unique()
# fingerprint_variant_all$REFERENCE
# fingerprint_variant_all$QUERY
# 
# fingerprint_variant_alpha <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_EPI_ISL_710528_alpha.csv")
# fingerprint_variant_delta <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_EPI_ISL_2693246_delta.csv")
# fingerprint_variant_omicron <- vroom("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_EPI_ISL_omicron.csv")
...
SNPs_MT007544_1_australia <- readRDS("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_MT007544_1_australia.rds")
SNPs_EPI_ISL_omicron <- readRDS("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_EPI_ISL_omicron.rds")
SNPs_EPI_ISL_2693246_delta <- readRDS("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_EPI_ISL_2693246_delta.rds")
SNPs_EPI_ISL_710528_alpha <- readRDS("/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_computed/SNPs_EPI_ISL_710528_alpha.rds")

SNPs_from_synthetic_controls <- bind_rows(SNPs_MT007544_1_australia, SNPs_EPI_ISL_omicron, SNPs_EPI_ISL_2693246_delta, SNPs_EPI_ISL_710528_alpha) %>% arrange(QUERY_POSITION, QUERY_TAG)
colnames(SNPs_from_synthetic_controls)
...
# all_samples <- bind_rows((all_lofreq %>% filter(FILTER == "PASS")), (all_ivar %>% filter(FILTER == "PASS")), (all_umivar %>% filter(FILTER == "PASS")), (all_varscan %>% filter(FILTER == "PASS"))) %>% unique %>% arrange(THESIS_IDENTIFIER, POS)
#all_samples <- bind_rows(all_lofreq, all_ivar, all_umivar, all_varscan, all_umivar, all_ivar, all_lofreq) %>% unique %>% arrange(THESIS_IDENTIFIER, POS)
# all_samples <- bind_rows(all_varscan, all_umivar, all_ivar, all_lofreq) %>% unique %>% arrange(THESIS_IDENTIFIER, POS) # max ncol first
...
file_data_unified <- "all_callers_with_features_and_metadata"
dir_data_unified <- "/mnt/bulk_data/bgilot/GitHub/2022_EKUT_THESIS_BIOINFO/data/data_unified"
all_callers_with_features_and_metadata <- readRDS(paste0(dir_data_unified, "/", file_data_unified, ".rds"))
...
write.csv(data_unified, paste0(dir_data_unified_bulk, "/", file_data_unified, ".csv"), row.names=FALSE, fileEncoding = "UTF-8")
# saveRDS(data_unified, paste0(dir_data_unified, "/", file_data_unified, ".rds"), compress = TRUE)
# vroom_write(data_unified, paste0(dir_data_unified_bulk, "/", data_unified, ".csv"),  progress = vroom_progress())
# infoRDS(paste0(dir_data_unified, "/", file_data_unified, ".rds"))
# readRDS(paste0(dir_data_unified, "/", file_data_unified, ".rds"))
...
for (filename_count in sample(counts_full_list)) { 
  ...
  sample_depth_statistics[nrow(sample_depth_statistics) + 1,] <- list(STAT_IDENTIFIER, STAT_DEPTH_MIN, STAT_DEPTH_QUANT_1, STAT_DEPTH_MEDIAN, STAT_DEPTH_MEAN, STAT_DEPTH_QUANT_3, STAT_DEPTH_MAX, STAT_DEPTH_SD, STAT_GINI_MIN, STAT_GINI_QUANT_1, STAT_GINI_MEDIAN, STAT_GINI_MEAN, STAT_GINI_QUANT_3, STAT_GINI_MAX, STAT_GINI_SD)
...
new_filename <- paste0(dir_save, "/", "sample_depth_statistics","_gini.csv")
print(new_filename)
...
new_filename <- paste0(dir_save, "/", "background_and_consensus_for_Marascuillo procedure.csv")
print(new_filename)
