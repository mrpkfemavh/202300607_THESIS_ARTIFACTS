...
file_all_snp_data_header="/home/bgilot/Downloads/SarsCovControls/column.header.csv"

touch ${file_all_snp_data}
head -n 1 ${file_all_snp_data_header} > ${file_all_snp_data}

for file_query in $(ls /home/bgilot/Downloads/SarsCovControls/*.fasta | sort | uniq); 
do 
...
cat $(ls /home/bgilot/Downloads/SarsCovControls/*.tsv | sort | uniq) >> ${file_all_snp_data}
touch ${file_all_snp_data}
